          ...
          <article className="intro-item">
            ...
            <div className="intro-content">
              ...
              <p className="intro-text">
                When I'm not at my computer I enjoy caring for my plant babies (all 60 and couting...) and spending time outdoors in my beautiful home here in the Sonoran desert.
              </p>
